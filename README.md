...
- 인터페이스
    ...
    ![인터페이스설명](https://raw.githubusercontent.com/kimdongju1/basic-csharp-2024/main/images/cs001.png)
...
- 예제 프로젝트
    - 윈도우 탐색기 앱(컨트롤학습)
        ...
        ![중간결과](https://raw.githubusercontent.com/kimdongju1/basic-csharp-2024/main/images/cs005.png)

        - 미적용 - 컨텍스트메뉴 리스트뷰 보기 가능, 더블클릭 프로그램 실행
...
- 토이 프로젝트
    - 도서관리 앱
        ...
        ![책대여프로그램](https://raw.githubusercontent.com/kimdongju1/basic-csharp-2024/main/images/cs006.png)
